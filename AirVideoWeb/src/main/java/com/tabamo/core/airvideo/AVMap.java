...
public class AVMap extends LinkedHashMap<String, Object> {
	...
	public static AVMap parse (InputStream i) {
		...
		AVMap result = null;
		dataReader = new DataReader(obj.__input);
...
//	public static AVMap parse (DataInputStream i) {
//		AVMap obj = new AVMap();
//		obj.__input = new DataInputStream(i);
//		
//		AVMap result = null;
//		dataReader = new DataReader(i);
//		
//		try {
//			result = (AVMap)obj.readIdentifier(0);
//		} catch (Exception e) {
...
//		return this.getStringFromByte(b);
	}
	
	public String getStringFromByte(byte[] byteInput) throws UnsupportedEncodingException {
		...
		for (int i = 0; i < byteInput.length; i++) {
			...
			if ((byteInput[i] & 0x80) == 0x80) {
				...
				sb.append(new String(byteKorean, "utf-8"));
